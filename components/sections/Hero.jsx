            ...
            <div className="mx-auto grid max-w-6xl items-center gap-8 xl:gap-12 grid-cols-1 lg:grid-cols-[1fr_0.65fr]">
                ...
                <Reveal direction="right">
                    <motion.div
                        ...
                        className="card-shadow grain relative mx-auto aspect-4/4.5 max-h-105 w-full max-w-md sm:max-h-120 lg:max-h-none lg:w-auto lg:max-w-none lg:aspect-4/4.5 border-6 border-white rounded-xl"
                    >
